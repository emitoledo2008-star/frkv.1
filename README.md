# FRK Integrativa — Plataforma Web & Catálogo de Botica Natural
...
* **Catálogo de Botica Natural (35 Productos Organizados):**
  * 🧬 **Aminoácidos** (8 productos)
  * 🌿 **Extractos Herbolarios** (10 productos)
  * 🍯 **Miel Orgánica & Apícolas** (6 productos)
  * 🌸 **Flores de Bach** (6 productos)
  * 📚 **Cursos de Alimentación** (5 productos)
* **Integración WhatsApp:**
  * Botón para agendar citas con mensaje preconfigurado (`wa.me/525574714726`).
  * Carrito de pedido con cotizador interactivo y envío del desglose completo en un solo clic.
...
frk-integrativa/
├── assets/
│   └── logo.png              # Logotipo oficial FRK Integrativa
├── index.html                # Plataforma web principal (HTML5 + Tailwind CSS + Lucide Icons)
...
* **WhatsApp:** [+52 55 7471 4726](https://wa.me/525574714726)
* **Horarios de Atención:** Lunes a Viernes de 10:00 a 18:00 hrs | Sábados de 10:00 a 14:00 hrs
